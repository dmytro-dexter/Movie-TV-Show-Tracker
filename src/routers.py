...
@router.get("/movies/by-id/{movie_id}", response_model=schemas.MovieBase)
...
@router.get("/movies/by_title/{movie_title}", response_model=schemas.MovieBase)
...
@router.put("/movies/by-title/{movie_title}", response_model=schemas.MovieBase,
            description="Rating should be set in 1 to 5 range, otherwise it will be Null")
...
@router.put("/movies/by-id/{movie_id}", response_model=schemas.MovieBase,
            description="Rating should be set in 1 to 5 range, otherwise it will be Null")
